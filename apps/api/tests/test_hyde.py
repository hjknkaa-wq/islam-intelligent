...
class TestHyDEEdgeCases:
    ...
    def test_get_embedding_with_very_long_query(
        ...
        """
        Verify that get_embedding produces a 1536-length embedding list for a very long input when the HyDE service is unavailable.
        """
        monkeypatch.delenv("OPENAI_API_KEY", raising=False)
        expander = HyDEQueryExpander()
...
class TestHyDEWithMockedLLM:
    ...
    def test_expand_with_mocked_llm_success(
        ...
        class MockCompletions:
            def create(self, **kwargs: object) -> MockCompletion:
                """
                Create and return a new MockCompletion instance.
                
                Parameters:
                    **kwargs: Arbitrary keyword arguments accepted for interface compatibility; they are not used by this implementation.
                
                Returns:
                    MockCompletion: A fresh MockCompletion object.
                """
        ...
        def mock_openai_init(*args: object, **kwargs: object) -> MockClient:
            """
            Create and return a new MockClient instance for tests.
            
            Any positional or keyword arguments are ignored; this function serves as a stable replacement for OpenAI client initialization in unit tests.
            
            Returns:
                MockClient: A new MockClient used to simulate the OpenAI client.
            """
            return MockClient()
    ...
    def test_expand_with_mocked_llm_exception(
        ...
        class MockCompletions:
            def create(self, **kwargs: object) -> None:
                """
                Raise a RuntimeError indicating an API error.
                
                Raises:
                    RuntimeError: Always raised with the message "API error".
                """
    ...
    def test_get_embedding_with_mocked_success(
        ...
        def mock_generate_embedding(self: object, text: str) -> list[float]:
            """
            Return a predefined mock embedding vector.
            
            Returns:
                list[float]: The predefined embedding vector (`mock_embedding`), returned unchanged regardless of the `text` input.
            """
