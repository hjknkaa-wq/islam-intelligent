...
class RAGPipelineMetrics:
    ...
    def finalize(self) -> None:
        """Finalize metrics by calculating total latency."""
...
class MetricsCollector:
    ...
    def __init__(
        ...
        Args:
            ...
            sinks: Custom metrics sinks. If None, uses default sinks.
    ...
    def end_stage(self, stage: str) -> float:
        """End timing a pipeline stage and return latency in ms."""
    ...
    def record_verification(
        ...
        """Record verification stage metrics."""
    ...
    def record_verdict(
        ...
        """Record the final pipeline verdict."""
    ...
    def record_ragas(
        ...
        *,
        ...
        """Record RAGAS-style scores on 0..1 scale."""
    ...
    def finalize_and_record(self) -> RAGPipelineMetrics:
        """Finalize metrics and persist to all sinks."""
